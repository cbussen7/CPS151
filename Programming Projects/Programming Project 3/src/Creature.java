...
public class Creature {
    ...
    /**
     * method is used as a constructor for the Creature class - takes in values for name, species, strength,
     * and hitPoints
     * @param newName name of creature to be assigned to name
     * @param newSpecies name of species to be assigned to species
     * @param newStrength strength of creature to be assigned to strength
     * @param newHit number of hit points to be assigned to hitPoints
     * @throws IllegalArgumentException if strength or hitPoints are negative or if species
     * doesn't fit one of the given species
     */
    public Creature(String newName, String newSpecies, int newStrength, int newHit) throws IllegalArgumentException {
        ...
        //throw an error if either strength or hitPoints is negative
        if(strength < 0 || hitPoints < 0){
            IllegalArgumentException ex = new IllegalArgumentException("Strength and hit points must be positive");
            throw ex;
        }

        //throw an error if species is not one of: balrog, cyberdemon, elf, or human
        if(!(species.equals("b")) && !(species.equals("c")) && !(species.equals("e")) && !(species.equals("h"))){
            IllegalArgumentException ex = new IllegalArgumentException("Species must be: balrog, cyberdemon, elf, or human");
            throw ex;
        }
    }//end Creature constructor method

    /**
     * method is used as an alternate constructor for the Creature class - takes in name and species, assigns random
     * value to strength and hitPoints
     * @param newName name of creature to be assigned to name
     * @param newSpecies name of species to be assigned to species
     * @throws IllegalArgumentException if species doesn't fit one of the given species
     */
    public Creature(String newName, String newSpecies) throws IllegalArgumentException {
        //assign the parameter values to their respective instance variables
        name = newName;
        species = newSpecies;
    ...
    public int getDamage(){
        ...
        //demons have a 5% chance of special attack - if species is balrog (b) or cyberdemon (c) and specialAttack is less than 5, add 50 to damage
        if((species.equals("b") || species.equals("c")) && specialAttack < 5){
            damage = damage + 50;
        }
        //elves have a 10% chance of special attack - if species is elf (e) and specialAttack is less than 10, double damage
        if(species.equals("e") && specialAttack < 10){
            damage = damage * 2;
        }
        //return damage
        return damage;
