    ...
    public static ArrayList addPlayers(ArrayList<Creature> playerList) throws IllegalArgumentException {
        ...
        while(addPlayer){
            ...
            //otherwise, add player to players
                ...
                //create a new creature using the given name and species
                if(playerSpecies.equals("b")){
                    //create and add new Balrog object
                    Balrog newPlayer = new Balrog(playerName);
                    playerList.add(newPlayer);
                }
                else if(playerSpecies.equals("c")){
                    //create and add new Cyberdemon object
                    Cyberdemon newPlayer = new Cyberdemon(playerName);
                    playerList.add(newPlayer);
                }
                else if(playerSpecies.equals("e")){
                    //create and add new Elf object
                    Elf newPlayer = new Elf(playerName);
                    playerList.add(newPlayer);
                }
                else if(playerSpecies.equals("h")){
                    //create and add new Human object
                    Human newPlayer = new Human(playerName);
                    playerList.add(newPlayer);
                }
                //otherwise throw IllegalArgumentException error
                else{
                    IllegalArgumentException ex = new IllegalArgumentException("Invalid species");
                    throw ex;
                }
            }
        }
